...
\033[1;35;40m   .%>% .%%>' :%>>%%'.,%%%%%%%%%'.%%%%%' `%%%%.`%%%%%.%%%%> %%>%.
\033[1;35;40m  ,%>%' >>%%  >%' `%%%%'     `%%%%%%%'.,>,. `%%%%'     `%%%>>%%>%
\033[1;35;40m.%%>%' .%%>'  %>>%, %% oO ~ Oo %%%>>'.>>>>>>. `% oO ~ Oo'.%%%'%>%,
\033[1;35;40m%>'%> .%>%>%  %%>%%%'  `OoooO'.%%>>'.>>>%>>%>>.`%`OoooO'.%%>% '%>%
\033[1;35;40m%',%' %>%>%'  %>%>%>% .%,>,>,   `>'.>>%>%%>>>%>.`%,>,>' %%%%> .>%>,
\033[1;35;40m` %>% `%>>%%. `%%% %' >%%%%%%>,  ' >>%>>%%%>%>>> >>%%' ,%%>%'.%%>>%.
\033[1;35;40m .%%'  %%%%>%.   `>%%. %>%%>>>%.>> >>>%>%%%%>%>>.>>>'.>%>%>' %>>%>%%
\033[1;35;40m `.%%  `%>>%%>    %%>%  %>>>%%%>>'.>%>>>>%%%>>%>>.>',%>>%'  ,>%'>% '
...
\033[1;31;40m   __|                         __ __|            | 
\033[1;31;40m  (      _ \    \ \ \ /  _ \      |   _ \   _ \  | 
\033[1;31;40m \___| \___/ _| _| \_/ \___/     _| \___/ \___/ _| 
                                                                                                                                      
__________________________________________  
\033[1;34;40m-----------------------------------------------
\033[1;34;40mM9D3 BY  : ASHOK THAKUR RULEX
\033[1;34;40mFacebook : ASHOK HERE
\033[1;34;40m ITS ASHOK SARKAR HERE
\033[1;34;40m-----------------------------------------------"""
...
def sendtextconvo(comment):
    ...
    print("\033[1;20;23m",end = "")
    print (e.strftime("YOUR MASSAGE GONE :: Date - %d/%m/%Y  Time - %I:%M:%S %p"))
    print(">> CHUDTE RHO :: ", line, "\n")
